...
# Load data
df = pd.read_csv("./single_stations/2024_frequency_features_normalized.csv", sep=";")
...
print(classification_report(
    ...
    zero_division=0  # This suppresses the warning
))
...
plt.tight_layout()
plt.savefig("confusion_matrix_percent_single_stations.png", dpi=300, bbox_inches='tight')
plt.show()
...
joblib.dump(clf, "random_forest_model_single_stations.pkl")
joblib.dump(le, "label_encoder.pkl")

# Save feature names for later use
feature_names = X.columns.tolist()
joblib.dump(feature_names, "feature_names_single_stations.pkl")

print("Model training and evaluation complete!")
print(f"Files saved:")
print(f"  - Model: random_forest_model_single_stations.pkl")
print(f"  - Label encoder: label_encoder.pkl")
print(f"  - Feature names: feature_names_single_stations.pkl")
print(f"  - Confusion matrix: confusion_matrix_percent_single_stations.png")

# Additional recommendations
if rare_classes:
    print(f"\nRecommendations:")
    print(f"1. Consider collecting more data for classes: {rare_classes}")
